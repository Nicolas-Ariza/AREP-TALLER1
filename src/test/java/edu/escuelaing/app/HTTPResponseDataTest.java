...
import edu.escuelaing.app.taller.HTTPResponseData;

public class HTTPResponseDataTest{
    
    @Test
    public void shouldreturnHTMLIndex(){
        HTTPResponseData server = new HTTPResponseData();
        String correcString = "<!DOCTYPE html>\r\n" + //
        "<html>\r\n" + //
        "    <head>\r\n" + //
        ...
        "</html>\r\n" + //
        "";
        assertEquals(correcString, server.getIndexPage());
    }
    ...
    public void shouldReturnNotFoundPage(){
        ...
        String correcString = "<!DOCTYPE html>\r\n" +
                                ...
                                "</html>";
        assertEquals(correcString, server.getNotFoundPage());
    }

    @Test
    public void shouldReturnJSONErrorMessage(){
        HTTPResponseData server = new HTTPResponseData();
        String correctString = "{\"Not found\":\"The resource that you were looking for does not exist\"}";
        assertEquals(correctString, server.getJSONErrorMessage());
    }
}
